...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "BitcoinPlus-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.xbcbitcoinplus.co.uk", "seed2.xbcbitcoinplus.co.uk", ""};
static const string testnet_seeds[] = {"testnet-seed1.bitcoinplus.net",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 8884), true);
  }
  do {
